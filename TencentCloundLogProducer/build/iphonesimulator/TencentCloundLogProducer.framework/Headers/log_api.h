...
post_log_result * post_logs_from_lz4buf(const char *endpoint, const char * accesskeyId, const char *accessKey, const char *topic, const char *project, const char *logstore, lz4_log_buf * buffer, log_post_option * option);
