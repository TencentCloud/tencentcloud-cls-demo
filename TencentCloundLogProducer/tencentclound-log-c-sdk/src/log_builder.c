...
lz4_log_buf *serialize_to_proto_buf_with_malloc_no_lz4(log_group_builder *bder)
{
    ...
    lz4_log_buf *pLogbuf = (lz4_log_buf *)malloc(sizeof(lz4_log_buf) + len);
    pLogbuf->length = len;
...
void add_log_full_v2(log_group_builder *bder, uint32_t logTime, size_t logItemCount,
